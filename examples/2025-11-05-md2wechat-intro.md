...
excerpt: '一款功能强大的 Markdown 转微信公众号 HTML 转换工具，支持多种主题风格、代码高亮、数学公式渲染、Mermaid 图表等功能，完美适配微信公众号编辑器。'
tags:
   - 工具介绍
   - Markdown
   - 微信公众号
...
MD2WeChat 是一款专为微信公众号内容创作设计的 Markdown 转 HTML 转换工具。它能够将标准 Markdown 文件转换为微信公众号编辑器兼容的 HTML 格式，支持多种主题风格、代码语法高亮、数学公式渲染、Mermaid 图表等丰富功能，让您的技术文章、产品介绍、节日祝福等内容在微信公众号中完美呈现。
...
1. **WeChatHTMLConverter**：主转换器类，协调各个组件
2. **MarkdownParser**：Markdown 解析器，处理 Front Matter 和正文内容
3. **CodeBlockFormatter**：代码块格式化器，支持语法高亮和缩进保留
4. **FormulaProcessor**：公式处理器，支持多种渲染方式
...
- ✅ 仅使用微信支持的标签：`<p>`, `<span>`, `<img>`, `<br>`, `<strong>`, `<em>`, `<div>` 等
...
MD2WeChat 是一款专为微信公众号内容创作设计的 Markdown 转 HTML 转换工具，它解决了技术文章在微信公众号中格式丢失、代码缩进错误、公式显示异常等问题。通过多主题支持、代码高亮、公式渲染、Mermaid 图表等功能，让您的技术内容在微信公众号中完美呈现。
